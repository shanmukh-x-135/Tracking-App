...
export default function CreditsPage() {
  return <div className="page"><div className="page-narrow">
    ...
    <section className="credits-grid" aria-label="Catalog data providers">
      ...
      <article className="credit-card"><div className="credit-brand"><span className="credit-wordmark">JustWatch</span></div><h2>Watch availability</h2><p>Movie and series availability is supplied through TMDB watch-provider data, powered by JustWatch. Availability varies by selected region.</p><a className="text-link" href="https://www.justwatch.com" target="_blank" rel="noopener noreferrer">Visit JustWatch ↗</a></article>
