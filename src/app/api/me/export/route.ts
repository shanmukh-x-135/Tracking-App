...
export async function GET() {
  ...
  const data: MosaicExportData = {
    ...
    "movie-watch-logs": (movieWatches.data ?? []).map((watch) => ({ id: watch.id, mediaId: watch.media_id, watchedAt: watch.watched_at, isRewatch: watch.is_rewatch, rating: watch.rating, review: watch.review, viewingContext: watch.viewing_context, streamingService: watch.streaming_service, createdAt: watch.created_at, updatedAt: watch.updated_at })),
