  ...
  return <>
    <header className="desktop-nav glass">
      ...
      <div className="nav-actions">
        ...
        <button className="button" onClick={() => setLogOpen(true)}><Plus size={15}/>Log</button>
    ...
    <nav className="mobile-nav glass" aria-label="Mobile navigation">
      ...
      <button className="mobile-link log" onClick={() => setLogOpen(true)}><Plus size={22}/>Log</button>
