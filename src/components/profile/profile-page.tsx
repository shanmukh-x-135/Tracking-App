...
export function ProfilePage() {
  ...
  return <div className="page"><div className="page-narrow">
    ...
    <div className="profile-shortcuts"><Link href="/activity"><Clock3 size={16}/>Activity & diary</Link><Link href="/library"><BookOpen size={16}/>Your library</Link><Link href="/lists"><List size={16}/>Your lists</Link><Link href="/settings/data"><Settings size={16}/>Your data</Link></div>
