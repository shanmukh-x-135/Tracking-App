...
const sources: { value: ImportSource; label: string; detail: string; native: boolean }[] = [
  ...
  { value: "generic_series", label: "Series CSV", detail: "For Serializd or other TV history", native: false },
  { value: "generic_games", label: "Games CSV", detail: "For Backloggd or other game history", native: false },
  { value: "generic_books", label: "Books CSV", detail: "For Fable or other reading history", native: false },
];
