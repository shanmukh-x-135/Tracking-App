...
export interface MediaItemRow extends Timestamped { media_type: "movie"|"tv"|"game"|"book"; provider: "tmdb"|"igdb"|"google_books"|"mock"; external_id: string; title: string; original_title: string|null; poster_url: string|null; backdrop_url: string|null; release_date: string|null; release_year: number|null; metadata: Json }
