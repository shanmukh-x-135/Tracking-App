...
export const catalogMediaSchema = z.discriminatedUnion("mediaType", [
  z.object({ ...base, mediaType: z.literal("movie"), runtimeMinutes: z.number().int().positive().optional(), director: optionalText }),
  z.object({ ...base, mediaType: z.literal("tv"), seasonCount: z.number().int().nonnegative().optional(), episodeCount: z.number().int().nonnegative().optional(), network: optionalText }),
